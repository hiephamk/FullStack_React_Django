...
from .serializers import PostSerializer, CommentSerializer, CirclesSerializer, CircleNotificationSerializer
...
def share_post_with_circle(request, post_id):
    if request.method == 'POST':
        ...
        new_post.save(update_fields=['created_at', 'updated_at'])
