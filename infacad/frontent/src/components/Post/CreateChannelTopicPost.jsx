                        ...
                        {selectedSubtopic === subtopic.id && (
                          <div>
                            ...
                            <CreatePost 
                              ...
                              setPosts={setPosts} 
                              fetchPostsBySubtopic={fetchPostsBySubtopic} />
                          </div>
                          ...
                          .map((comment) => (
                            <div key={comment.id} style={{ display: 'flex', alignItems: 'center', padding: '20px' }}>
                              ...
                              <p className="d-flex flex-column rounded " style={{ backgroundColor: '#f8f8f8', margin: '10px', boxShadow: '2px 2px #1113', padding: '10px' }} >
                                <strong><Link to={`/community/random_lookup/${comment.random_lookup}`}>{comment.author_name}</Link></strong>
...
export default CreateChannelTopicPost;
