...
const CreateOrUpdateAccount = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (profileImg instanceof File) {
      formData.append('profile_img', profileImg); // New image file
    } else if (profileImg) {
      formData.append('profile_img_url', profileImg); // Existing image URL
    }
  ...
  return (
    <div  >
      {
        accountId?
        (<form onSubmit={handleFormSubmit} className='form-container text-black'>
        ...
        <div className="form-group d-flex flex-column align-items-md-center">
          ...
          <div>
            ...
            <img style={{width:'40px'}} src={profileImg} alt="" />
          </div>
          <input
            type="file"
            accept="image/*"
