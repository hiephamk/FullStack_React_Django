...
const PostList = () => {
    ...
    return (
        <div className="container">
            <div>
              {posts.map((post) => (
                <div key={post.id} className="container border rounded-3 my-2" style={{color:'#fff', backgroundColor: '#4682B4',width:'60%', paddingTop:'20px'}}>
                  <div className="rounded-2" style={{paddingLeft:'0 20px 0 20px'}}>
                    <div className="d-flex flex-column p-2 my-2" style={{fontSize:'18px'}}>
