...
const CreatePost = ({ postId, setPosts }) => {
  ...
  return (
    <div>
      <form onSubmit={handlePost} className=" container d-flex justify-content-evenly align-self-center my-2 " style={{width:'52%'}}>
        <input
        ...
        />
        <button type="submit" className='px-5, rounded' style={{border:'1px solid #fff', padding:'0 18px'}}>Send</button>
      </form>
    </div>
  );
};
